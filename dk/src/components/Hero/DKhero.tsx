...
const DKhero = () => {
  ...
  return (
    <section className="max-w-[100vw] bg-[#f7f7f7] max-sm:bg-dark-background  ">
            ...
            <div className="  flex items-center justify-center absolute  z-50   w-[100vw]">
              <div className=" text-white container mt-[30%] sm:mt-[18%] flex flex-col items-center gap-4 justify-center   font-bold text-center">
                <h1
                  data-aos-delay="300"
                  data-aos="fade-up"
                  className="text-xl sm:text-2xl lg:text-4xl tracking-wider  "
                >
                ...
                <p  data-aos-delay="600"
                  data-aos="fade-up" className="lg:w-[50%] text-sm font-extralight  text-slate-100 tracking-wider leading-5">
                  Your trusted partner in connecting skilled professionals to
            ...
            <div className=" flex items-center justify-center absolute  z-50   w-[100vw] ">
              <div className=" text-white container mt-[30%] sm:mt-[18%] flex flex-col items-center gap-4 justify-center   font-bold text-center">
                ...
                <p
                  data-aos="fade-up"
                  data-aos-delay="300"
                  className="lg:w-[50%] text-sm font-extralight  text-slate-100 tracking-wider leading-5"
                >
          ...
          <div className="w-full h-[50vh] sm:h-[80vh] ">
            <div className="  flex items-center justify-center absolute  z-50   w-[100vw]">
              <div className=" text-white container mt-[30%] sm:mt-[18%] flex flex-col items-center gap-4 justify-center   font-bold text-center">
                ...
                >
                  {/* Empowering Your Success <br /> with Skilled Hands <br /> */}
                  Connecting Talent with Opportunity <br /> for a Brighter
                  Future
                </h1>
                <p className="lg:w-[50%] text-sm font-extralight  text-slate-100 tracking-wider leading-5">
                  Your reliable partner in matching skilled professionals with
                  fulfilling career paths in Poland.
                </p>
              </div>
            </div>
            <Image
